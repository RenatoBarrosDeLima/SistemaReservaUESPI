...
<html lang="pt-BR">
    <head>
        ...
        <title>Cadastro De Laboratorio</title>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-8">
                                <div class="card">
                                    <div class="header">
                                        <h4 class="title">Cadastro de Laboratório</h4>
                                    </div>
                                    <div class="content">
                                        <form id="formularioEquipamento" action="../../controller/LaboratorioController.php" method="post" nome="formularioEquipamento" >
                                            <div class="row">
                                                <div class="col-md-5">
                                                    <div class="form-group">
                                                        <input type="hidden" id="action" name="action" />
                                                        <label>Nome</label>
                                                        <input type="text" id="inputName" name="nome" class="form-control" placeholder="Nome" required autofocus></br>

                                                        <label>Setor</label>
                                                        <input type="text" id="inputTombo" name="setor" class="form-control" placeholder="Setor" required ></br>

                                                        <label>Sala</label>
                                                        <input type="text" id="xxxx" name="sala" class="form-control" placeholder="Sala" required></br>
